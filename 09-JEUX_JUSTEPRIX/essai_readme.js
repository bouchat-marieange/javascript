...
var nb_essai = 0; // on déclare la variable nb_essai et on lui attribue la valeur de 0. Au départ l'utilisateur n'a pas encore fait d'essai. Cette valeur sera augmenté de 1 à chaque essai grâce à une instruction dans la fonction devine
